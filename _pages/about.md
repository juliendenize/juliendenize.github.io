...
## Previous Role: Machine Learning Engineer at CEA List
Previously at [CEA List](https://list.cea.fr/fr/), I helped improve MLOps workflows for an AI R&D team of 80+ researchers, including data management, annotation, model training, testing, and deployment processes. I also led the team developing [Pixano](https://github.com/pixano/pixano), an open-source data annotation framework, and contributed to applied AI projects involving LLMs, VLMs, edge deployment, and generative AI.
